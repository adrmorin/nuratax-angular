...
@Component({ selector: 'app-form-6781', standalone: true, imports: [CommonModule, FormsModule, ReactiveFormsModule, ChatFormsComponent], templateUrl: './form6781.component.html', styleUrls: ['./form6781.component.css'] })
export class Form6781Component implements OnInit {
    ...
    constructor() {
        this.taxForm = this.fb.group({ name: [''], ssn: [''], markToMarket: [0], priorYear: [0], totalGain: [0], sixtyPct: [0], fortyPct: [0] });
    ...
    onSubmit(): void { if (this.taxForm.valid) console.log('Form 6781 Submitted', this.taxForm.getRawValue()); else this.taxForm.markAllAsTouched(); }
}